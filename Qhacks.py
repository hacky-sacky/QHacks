...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        thing_to_do_btn.bind("<Button-1>", lambda event: show_events_page())
                    ...
                    with open(events_file, "r") as file:
                        for line in file:
                            ...
                            if title == event_title:
                                ...
                                no_events_label = tk.Label(events_frame, text="Event details not found.", font=("Montserrat", 14))
        ...
        def show_events_page():
            """
            Displays the 'Events' page with all events added by users.
            Reads the txt file that contains event details and creates a list of events with buttons.
            Clicking a button displays the corresponding event's details.
            """
            events_window = tk.Toplevel()
            events_window.title("Events")
            events_window.geometry("600x600")
            ...
            if os.path.exists(events_file):
                with open(events_file, "r") as file:
                    for line in file:
                        ...
                        event_button = ttk.Button(events_window, text=title, command=lambda t=title: show_details_of_event(t))
